{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Create a function that takes in three arguments, first define a variable for the directory that has the data:\n",
    "file_dir = 'C:/Users/lrinc/DataAustin2020/Movies-ETL/'"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "# Create a DataFrame from wiki_movies_raw in order to determine the # of rows/columns of the df as well as determine which data needs to be cleaned.\n",
  ...
  },
  {
   ...
   "source": [
    "# DataFrame has too many columns, therefore convert the df columns to a list in order to see all of the columns. \n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Modify JSON data by restricting it to only those entries that have a 'Director', an 'IMDb link' & does not have 'No. of episodes' which are TV shows.\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    # 3. Check if the current key exists in the movie object, if so, remove the key-value pair and add alt titles dictionary.\n",
    "    # 4. Consolidate columns with the same data into one column.\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Extract IMDb ID from IMDb link using regular expressions (r') and then drop any duplicates of IMDb IDs.\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Make a list of columns that have less than 90% null values in order to remove colums that don't have useful data.\n",
  ...
  },
  {
   ...
   "source": [
    "# Based on looking through the data, 'Box office', 'Budget', 'Release date' and 'Running time' need to be converted.\n",
    "    # 1. We'll start with 'Box office' and drop any missing values and check the number of data points that exist after dropping.\n",
  ...
  },
  {
   ...
   "source": [
    "# Create the First Form which will include the following six elements: \n",
    "    #1. A dollar sign, \n",
    ...
    "# Then, count how many box office values match the first form &\n",
    "# Ignore whether letters are uppercase or lowercase by adding argument called flags equal to re.IGNORECASE.\n",
  ...
  },
  {
   ...
   "source": [
    "# Create the Second Form to match the numbers of our second form, \"$123,455,789.\" It will include the following elements:\n",
    "    #1. A dollar sign,\n",
    "    #2. A group of one to three digits,\n",
    "    #3. At least one group starting with a comma and followed by exactly three digits.\n",
    "# Then, count how many box office values match the second form &\n",
    "# Ignore whether letters are uppercase or lowercase by adding argument called flags equal to re.IGNORECASE.\n",
  ...
  },
  {
   ...
   "source": [
    "# Create two Boolean Series and then select the box office values that don't match either.\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Extract and convert the Box Office values using parse_dollars.\n",
  ...
  },
  {
   ...
   "source": [
    "# Based on looking through the data, 'Box office', 'Budget', 'Release date' and 'Running time' need to be converted.\n",
    "    # 2. Next, we'll look at 'Budget' and drop any missing values and check the number of data points that exist after dropping.\n",
  ...
  },
  {
   ...
   "source": [
    "# Use the two Boolean Series from the box office data and apply them without modifications.\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Copy the line of code we used to parse box office values, changing \"box_office\" to \"budget\"\n",
  ...
  },
  {
   ...
   "source": [
    "# Based on looking through the data, 'Box office', 'Budget', 'Release date' and 'Running time' need to be converted.\n",
    "    # 3. Next, we'll look at 'Release date' and drop any missing values and check the number of data points that exist after dropping.\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Extract the dates using built-in to_datetime() method in Pandas.\n",
  ...
  },
  {
   ...
   "source": [
    "# Based on looking through the data, 'Box office', 'Budget', 'Release date' and 'Running time' need to be converted.\n",
    "    # 4. Next, we'll look at 'Running time' and drop any missing values and check the number of data points that exist after dropping.\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Extract values (only digits, and we want to allow for both possible patterns)\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Apply a function to convert the hour capture groups and minute capture groups to minutes if the pure minutes capture group is zero.\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Drop Running time form dataset. \n",
  ...
  },
  {
   ...
   "source": [
    "# Clean the Kaggle Data, first check that all columns have the correct data types. \n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# For the numeric columns, we will use the to_numeric method from Pandas:\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Convert 'release date' to datetime using Pandas built-in function to_datetime().\n",
  ...
  },
  {
   ...
   "source": [
    "# Convert ratings data to datetime data type as it will be in its own table in SQL.\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Pairs of columns that have redundant information and the resolution we will take:\n",
    "\n",
    "# Competing data:\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Drop row from df due to incorrect data.\n",
  ...
  },
  {
   ...
   "source": [
    "# Run the function fo the three column pairs that we decided to fill in zeros.\n",
  ...
  },
  {
   ...
   "source": [
    "# Check that there aren't any columns with only one value, since that doesn't provide any information:\n",
  ...
  },
  {
   ...
   "source": [
    "# Since video is false for every row, we don't need to include this column.\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Reoder columns in order to make the dataset easier to read for the hackathon participants. \n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Transform and Merge Rating Data. First, use groupby on the \"movieId\" and \"rating\" columns and take the count for ea. group.\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Prepend \"rating\" to each column so they're easier to understand. \n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Merge ratings count into movies_df.\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Fill in missing values, since not every movie got a rating. \n",
